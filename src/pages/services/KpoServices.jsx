...
const ExpandableCards = () => {
  ...
  return (
    ...
    <Helmet>
            ...
            <meta name="description" content="Explore Evron Research's KPO services to streamline your recruitment processes." />
    ...
    <div >
          ...
          <div className="fixed inset-0 grid place-items-center z-[100] p-4 bg-black/30 backdrop-blur-sm ">
            ...
            >
              ...
              <div className="w-full md:w-1/2 overflow-y-auto p-6 md:p-8 flex flex-col justify-between">
                ...
                <div className="mt-6">
                  <Button  className="h-10 w-full max-w-[200px] bg-[#260433] hover:bg-fuchsia-950  px-4 py-2 text-sm font-medium sm:w-auto text-white"
              radius="full">
                    Contact Us
                  </Button>
                </div>
      ...
      {/* Cards Grid */}
      <div className="max-w-6xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 gap-4 px-4 mb-10" >
